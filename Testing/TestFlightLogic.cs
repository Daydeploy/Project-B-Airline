...
public class TestFlightLogic
{
    ...
    {
        // Arrange: Create a list of flights with different origins
        List<FlightModel> flights = new List<FlightModel>
        {
            new FlightModel { FlightId = 1, Origin = "RTM", Destination = "LHR", Price = 100 },
            new FlightModel { FlightId = 2, Origin = "AMS", Destination = "LHR", Price = 150 },
            new FlightModel { FlightId = 3, Origin = "RTM", Destination = "JFK", Price = 200 },
        };
    ...
    {
        // Arrange: Create a list of flights with different prices
        List<FlightModel> flights = new List<FlightModel>
        {
            new FlightModel { FlightId = 1, Origin = "RTM", Destination = "LHR", Price = 100 },
            new FlightModel { FlightId = 2, Origin = "RTM", Destination = "JFK", Price = 250 },
            new FlightModel { FlightId = 3, Origin = "RTM", Destination = "AMS", Price = 75 },
        };
    ...
    public void ConfirmBooking_UpdatesSeatsAndSavesPassengerDetails()
    {
        ...
        List<FlightModel> flights = new List<FlightModel>
        {
            new FlightModel { FlightId = 1, Origin = "RTM", Destination = "LHR", Price = 100, AvailableSeats = 10 }
        };

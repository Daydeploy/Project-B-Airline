public class PaymentLogic
{
    ...
    public static bool ValidateName(string name)
    {
        ...
        if (!name.All(c => char.IsLetter(c) || char.IsWhiteSpace(c))) return false;
    ...
    public static bool ValidateExpirationDate(string expirationDate)
    {
        ...
        var isValidMonth = int.TryParse(parts[0], out var month);
        var isValidYear = int.TryParse(parts[1], out var year);
        ...
        if (expirationDateTime < DateTime.Now) return false;
